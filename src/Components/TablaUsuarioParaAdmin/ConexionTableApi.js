...
import TableUsuariosVistoAdmin from './TableUsuariosVistoAdmin';

const ConexionTableApi = () => {
  ...
  return (
    <TableUsuariosVistoAdmin data={db} setDataToEdit={setDataToEdit} deleteData={deleteData} />
  )
}

export default ConexionTableApi;